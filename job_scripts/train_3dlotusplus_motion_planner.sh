...
output_dir=data/experiments/gembench/3dlotusplus/v4
checkpoint=data/experiments/gembench/3dlotusplus/v3/ckpts/train_state_latest.pt
...
python genrobo3d/train/train_motion_planner.py \
